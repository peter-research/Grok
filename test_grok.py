...
class GrokHelpersTest(unittest.TestCase):
    ...
    def test_command_names_are_unique(self) -> None:
        ...
        for name in ("roman", "snake", "camel", "caesar", "rle", "hash", "dice", "mode", "unb64", "hamming", "variance", "collatz", "xor", "weekday", "nrange", "digitsum", "tri", "isqrt", "luhn", "kebab", "pascal", "perfect", "julian", "isbn", "oct", "pangram", "until", "droot", "bits", "isbn13", "leap", "swap", "c2f", "abundant", "f2c", "deficient", "square", "cube", "mid"):
