...
| `_part1.py` … `_part17.py` | Original CLI pieces |
...
See `python3 grok.py commands` for the full list. v0.40 reaches 165 commands and adds hexagonal, happy, kaprekar, catalan and aliquot.
